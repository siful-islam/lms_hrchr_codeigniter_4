...
class Data_center extends BaseController
{
    ...
    function __construct()
    {
        ...
        if(strpos(base_url(), 'demo.creativeitem.com')){
            $this->session->setFlashdata('error_message', "This feature is not available in the demo platform.");
    ...
    function demo_importer()
    {
        ...
        if(empty($_FILES["data_file"]["name"])){
            $this->session->setFlashdata('error_message', get_phrase('please_select_your_zip_file'));
            redirect(site_url('admin/data_center'), 'refresh');
        }
        ...
        if(!strpos($_FILES["data_file"]["name"], get_settings('version'))){
            $this->session->setFlashdata('error_message', get_phrase('version_mismatching').'!');
            redirect(site_url('admin/data_center'), 'refresh');
        }
        ...
        if (class_exists('ZipArchive')) {
            ...
            $files_and_folders = glob(ROOTPATH . '*', GLOB_MARK);
        ...
        $this->session->setFlashdata('imported_message', get_phrase('created_a_backup_file_of_your_old_data'));
        $this->session->setFlashdata('flash_message', get_phrase('demo_imported_successfully'));
        redirect(site_url('admin/data_center'), 'refresh');
    }
    ...
    function download_zip_file($folder_name){
        ...
        $this->session->setFlashdata('flash_message', get_phrase('downloaded_successfully'));
        redirect(site_url('admin/data_center'), 'refresh');
    }
    ...
    public function delete_dir($dirName = ""){
        ...
        $this->session->setFlashdata('flash_message', get_phrase('backup_files_deleted_successfully'));
        redirect(site_url('admin/data_center'), 'refresh');
    }
    ...
    function create_backup_file(){
        ...
        $this->session->setFlashdata('flash_message', get_phrase('your_backup_file_has_been_stored_successfully'));
        redirect(site_url('admin/data_center'), 'refresh');
    }
    ...
    function language_import(){
        ...
        $this->session->setFlashdata('flash_message', get_phrase('language_file_imported_successfully'));
        redirect(site_url('admin/data_center'), 'refresh');
    }
