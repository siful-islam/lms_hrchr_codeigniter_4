...
$provider = "";
    ...
    if ($course_details['course_overview_provider'] == "html5") {
        ...
        $video_details = $videoModel->getVideoDetails($course_details['video_url']);
        $provider = 'vimeo';
    }
?>
...
<!------------- PLYR.IO ------------>
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/plyr/plyr.css">
<video poster="<?php echo $crudModel->get_course_thumbnail_url($course_details['id']); ?>" id="player" playsinline controls>
