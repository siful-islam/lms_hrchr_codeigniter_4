                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="conversation ">
                                ...
                                <div class="conversation-body-scroll-bar">
                                    <?php
                                    $db->where('sender', $user_details['id']);
                                    $db->orWhere('receiver', $user_details['id']);
                                    $message_threads = $db->table('message_thread')->get()->getResultArray();
                                    ...
                                    foreach ($message_threads as $row) :
                                        ...
                                        $number_of_unreaded_message = $crudModel->count_unread_message_of_thread($row['message_thread_code']);
                                        $conversation_user_info = $userModel->get_all_user($conversation_user_id)->getRowArray();
                                        $last_messages_details =  $crudModel->get_last_message_by_message_thread_code($row['message_thread_code'])->getRowArray();
                                                ...
                                                <div class="conversation-1">
                                                    <div class="conversation-heading">
                                                        <div class="conversation-img">
                                                            <img loading="lazy" class="rounded-circle" src="<?php echo $userModel->get_user_image_url($conversation_user_info['id']); ?>">
                        ...
                        <div class="col-lg-8 c-border ">
                            ...
                            if ($this_conversation_user_info != '') :
                                $messages = $db->table('message')->where(array('message_thread_code' => $message_thread_code))->get()->getResultArray(); ?>
                                <div class="conversation-text message-box-content">
                                    <div class="conversation-text-2" style="overflow: auto;">
                                        <div class="conversation-msg-full">
                                            <div class="parrent">
                                                <div class="child-img">
                                                    <img loading="lazy" src="<?php echo $userModel->get_user_image_url($this_conversation_user_info['id']); ?>" class="parrent-image mb-2">
                                                </div>
                                        ...
                                        <?php foreach ($messages as $message) :
                                            if ($message['sender'] == session()->get('user_id')) {
                                                $conversation_user = $userModel->get_all_user(session()->get('user_id'))->getRowArray();
                                            } else {
                                                $conversation_user = $userModel->get_all_user($message['sender'])->getRowArray();
                                            } ?>
                                            <div class="conversation-msg-full">
                                                <div class="parrent parrent-3rd">
                                                    <div class="parrent-2">
                                                        <div class="child-img">
                                                            <img loading="lazy" src="<?php echo $userModel->get_user_image_url($conversation_user['id']); ?>">
                                                        </div>
                                ...
                                <div class="conversation-sending">
                                    <form action="<?php echo site_url('home/my_messages/send_new'); ?>" method="post" class="mt-5">
                                        <div class="form-group mb-3">
                                            <?php $instructor_list = $userModel->get_instructor_list()->getResultArray(); ?>
                                            ...
                                            <select class="form-control my-2 py-3 radius-5" name="receiver">
                                                <?php foreach ($instructor_list as $instructor) :
                                                    if ($instructor['id'] == session()->get('user_id'))
                                                        continue;
                                                ?>
                                                ...
                                                <?php if (isset($_GET['instructor_id']) && $_GET['instructor_id'] > 0) : ?>
                                                    <?php $user_details = $userModel->get_all_user($_GET['instructor_id'])->getRowArray(); ?>
