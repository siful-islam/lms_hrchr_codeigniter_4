                        ...
                        <p class="info">
                            <span>
                                <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M0 7.75C5 7.15 6.91667 2.33333 7.25 0C7.65 5.4 11.9167 7.41667 14 7.75C8.09248 8.14383 7.03202 12.6092 7.23935 14.8943C7.24302 14.9294 7.24657 14.9646 7.25 15C7.24615 14.9653 7.24259 14.9301 7.23935 14.8943C6.59889 8.78615 2.1543 7.58428 0 7.75Z"
                                        fill="#FF5BE6" />
                                </svg>
                            </span>
    ...
    <div class="container">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                ...
                <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($latest_course['title'])) . '/' . $latest_course['id']); ?>" class="course-item-5"
...
<!-- Start Testimonial -->
<?php $ratings = $crudModel->get_pepople_ratings(); ?>
<?php if ($ratings->getNumRows() > 0): ?>
<section class="pb-110 wow animate__animated  animate__fadeInUp " data-wow-duration="1000" data-wow-delay="500">
    <div class="container text-center">
        ...
        <div class="testimonial-5">
            <?php foreach ($ratings->getResultArray() as $rating): ?>
            <?php $user_details = $userModel->get_all_user($rating['user_id'])->getRowArray(); ?>
            <div class="testimonial-item-5">
                ...
                <div class="title">
                    <div class="img eTestimonials">
                        <img loading="lazy" src="<?php echo $userModel->get_user_image_url($rating['user_id']); ?>" alt="" />
                    </div>
                    <div class="content">
                ...
                <a href="<?php echo site_url('blog/details/' . slugify($latest_blog['title']) . '/' . $latest_blog['blog_id']); ?>" class="blog-item-5">
                    ...
                    <div class="content">
                        <div class="courses-card-image">
                            ...
                            <img class="lazy" src="<?php echo $blog_thumbnail; ?>" alt="">
                        </div>
