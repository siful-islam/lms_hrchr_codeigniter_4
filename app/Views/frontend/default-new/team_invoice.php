...
$package_details = $db->where('id', $invoice['package_id'])->get('team_packages')->getRowArray();
$buyer_details = $userModel->get_all_user($invoice['user_id'])->getRowArray();
$course_details = $db->where('id', $package_details['course_id'])->get('course')->getRowArray();
$instructor_details = $userModel->get_all_user($package_details['user_id'])->getRowArray();
?>
