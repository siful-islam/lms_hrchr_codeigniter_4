                ...
                <div class="courses wishlist-course mt-5">
                    <div class="courses-card">
                        ...
                        <?php foreach($following_instructors as $instructor): ?>
                            <?php 
                            $db->where('id', $instructor->instructor_id);
                            $instructor_info = $db->table('users')->get()->getRowArray(); 

                            $is_following = $userModel->is_following($instructor->instructor_id, session()->get('user_id')); 
                            ?>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="checkPropagation courses-card-body">
                                    <div class="courses-card-image eimage">
                                        <img loading="lazy" src="<?php echo $userModel->get_user_image_url($instructor_info['id']);?>" alt="image">
                                    </div>
