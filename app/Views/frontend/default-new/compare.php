...
echo site_url('assets/global/select2/css/select2.min.css') ?>" rel="stylesheet" />
        ...
        <div class="row">
            	...
            	<?php if(isset($course_1_details['title'])): ?>
	                <div class="card  eGridCourse epopCourse courses-card-body position-relative">
	                    <div class="courses-card-image">
						   <img loading="lazy" src="<?php echo $crudModel->get_course_thumbnail_url($course_1_details['id']); ?>" alt="<?php echo $course_1_details['title']; ?>">
						</div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <?php if(isset($course_2_details['title'])): ?>
	                <div class="card  eGridCourse epopCourse courses-card-body position-relative">
						...
						<div class="courses-card-image">
	                        <img loading="lazy" src="<?php echo $crudModel->get_course_thumbnail_url($course_2_details['id']); ?>" alt="<?php echo $course_2_details['title']; ?>">
			        	</div>
					    	<div class="courses-text">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <?php if(isset($course_3_details['title'])): ?>
	                <div class="card  eGridCourse epopCourse courses-card-body position-relative">
	                   <div class="courses-card-image">
					        <img loading="lazy" src="<?php echo $crudModel->get_course_thumbnail_url($course_3_details['id']); ?>" alt="<?php echo $course_3_details['title']; ?>">
					   </div>
						<div class="courses-text">
                    ...
                    <tr>
                      ...
                      <td>
                      	<?php if(isset($course_1_details['title'])): ?>
							...
							<?php echo $db->table('lesson')->where(['course_id' => $course_1_details['id'], 'lesson_type !=' => 'quiz'])->get()->getNumRows(); ?>
                      	<?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_2_details['title'])): ?>
                      		<i class="fa-solid fa-book-open-reader"></i>
							<?php echo $db->table('lesson')->where(['course_id' => $course_2_details['id'], 'lesson_type !=' => 'quiz'])->get()->getNumRows(); ?>
                      	<?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_3_details['title'])): ?>
                      		<i class="fa-solid fa-book-open-reader"></i>
							<?php echo $db->table('lesson')->where(['course_id' => $course_3_details['id'], 'lesson_type !=' => 'quiz'])->get()->getNumRows(); ?>
                      	<?php endif; ?>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                      	<?php if(isset($course_1_details['title'])): ?>
                      		...
                      		<?php echo $crudModel->get_total_duration_of_lesson_by_course_id($course_1_details['id']); ?>
                      	<?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_2_details['title'])): ?>
                      		<i class="fa-regular fa-clock"></i>
                      		<?php echo $crudModel->get_total_duration_of_lesson_by_course_id($course_2_details['id']); ?>
                      	<?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_3_details['title'])): ?>
                      		<i class="fa-regular fa-clock"></i>
                      		<?php echo $crudModel->get_total_duration_of_lesson_by_course_id($course_3_details['id']); ?>
                      	<?php endif; ?>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                      	<?php if(isset($course_1_details['title'])): ?>
                      		...
                      		<?php echo $crudModel->enrol_history($course_1_details['id'])->getNumRows(); ?>
                      	<?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_2_details['title'])): ?>
                      		<img loading="lazy" src="<?php echo site_url('assets/frontend/default-new/image/Group 17906.png') ?>" alt="">
                      		<?php echo $crudModel->enrol_history($course_2_details['id'])->getNumRows(); ?>
                      	<?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_3_details['title'])): ?>
                      		<img loading="lazy" src="<?php echo site_url('assets/frontend/default-new/image/Group 17906.png') ?>" alt="">
                      		<?php echo $crudModel->enrol_history($course_3_details['id'])->getNumRows(); ?>
                      	<?php endif; ?>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                      	<?php if(isset($course_1_details['title'])): ?>
                      		...
                      		<?php echo $c_1_reviews = $crudModel->get_ratings('course', $course_1_details['id'])->getNumRows(); ?>
                      	<?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_2_details['title'])): ?>
                      		<i class="fa-regular fa-message"></i>
                      		<?php echo $c_2_reviews = $crudModel->get_ratings('course', $course_2_details['id'])->getNumRows(); ?>
                      	<?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_3_details['title'])): ?>
                      		<i class="fa-regular fa-message"></i>
                      		<?php echo $c_3_reviews = $crudModel->get_ratings('course', $course_3_details['id'])->getNumRows(); ?>
                      	<?php endif; ?>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                      	...
                      	if(isset($course_1_details['title'])):
	                      	$total_rating =  $crudModel->get_ratings('course', $course_1_details['id'], true)->getRow()->rating;
	                      	if ($c_1_reviews > 0) {
                      ...
                      <td>
                      	...
                      	if(isset($course_2_details['title'])):
	                      	$total_rating =  $crudModel->get_ratings('course', $course_2_details['id'], true)->getRow()->rating;
	                      	if ($c_1_reviews > 0) {
							    $average_ceil_rating = ceil($total_rating / $c_1_reviews);
							} else {
							    $average_ceil_rating = 0;
                      ...
                      <td>
                      	...
                      	if(isset($course_3_details['title'])):
	                      	$total_rating =  $crudModel->get_ratings('course', $course_3_details['id'], true)->getRow()->rating;
	                      	if ($c_1_reviews > 0) {
							    $average_ceil_rating = ceil($total_rating / $c_1_reviews);
							} else {
							    $average_ceil_rating = 0;
