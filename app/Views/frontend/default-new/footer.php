...
if(get_frontend_settings('recaptcha_status_v3')): ?>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-12 col-md-4 col-xl-4">
                        <div class="ft2-logo-area">
							...
							<ul> 
								<li><a class="ft2-nav-link" href="<?php echo site_url('home/contact_us'); ?>"><?php echo site_phrase('contact_us'); ?></a></li>
								<li><a class="ft2-nav-link" href="<?php echo site_url('home/about_us'); ?>"><?php echo site_phrase('about_us'); ?></a></li>
								<li><a class="ft2-nav-link" href="<?php echo site_url('home/privacy_policy'); ?>"><?php echo site_phrase('privacy_policy'); ?></a></li>
								<li><a class="ft2-nav-link" href="<?php echo site_url('home/terms_and_condition'); ?>"><?php echo site_phrase('terms_and_condition'); ?></a></li>
								<li><a class="ft2-nav-link" href="<?php echo site_url('home/faq'); ?>"><?php echo site_phrase('FAQ'); ?></a></li>
								<li><a class="ft2-nav-link" href="<?php echo site_url('home/refund_policy'); ?>"><?php echo site_phrase('refund_policy'); ?></a></li>
								<li>
							 ...
							 <h4 class="ft2-title mt-4 mb-4"><?php echo get_phrase('Subscribe to our Newsletter'); ?></h4>
