...
$course_details = $crudModel->get_course_by_id($payment_info['course_id'])->getRowArray();
$buyer_details = $userModel->get_all_user($payment_info['user_id'])->getRowArray();
$sub_category_details = $crudModel->get_category_details_by_id($course_details['sub_category_id'])->getRowArray();
