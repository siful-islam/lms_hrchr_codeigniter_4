                ...
                <div class="my-course-1-full-body">
                    ...
                    <div class="row">
                        <?php foreach($enrolments as $enrolment):
                            $course_details = $crudModel->get_course_by_id($enrolment['course_id'])->getRowArray();
                            ...
                            $course_progress = course_progress($course_details['id'], session()->get('user_id'));
                            ?>
                            <div class="col-lg-12 col-md-12 col-sm-6 col-12 mb-5">
                                <div class="my-course-1-full-body-card">
                                    <div class="my-course-1-img">
                                        <img loading="lazy" src="<?php echo $crudModel->get_course_thumbnail_url($course_details['id']); ?>" alt="">
                                    </div>
                                    <div class="my-course-1-text pt-1">
                                        ...
                                        <div class="my-course-1-lesson-text mb-2">
                                            <div class="icon-1">
                                                <p><i class="far fa-play-circle"></i> <?php echo get_phrase('Lectures').' '.$lectures->getNumRows(); ?></p>
                                            </div>
                                            <div class="icon-1">
                                                <p><i class="far fa-question-circle"></i> <?php echo get_phrase('Quizzes').' '.$quizzes->getNumRows(); ?></p>
                                            </div>
                                            <div class="icon-1">
                                        ...
                                        <div class="my-course-1-last">
                                            <div class="icon-img d-grid">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img loading="lazy" class="ms-0" src="<?php echo $userModel->get_user_image_url(session()->get('user_id')); ?>" alt="">
