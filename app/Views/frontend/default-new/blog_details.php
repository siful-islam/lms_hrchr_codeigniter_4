...
$user_details = $userModel->get_all_user($blog_details['user_id'])->getRowArray(); ?>
        ...
        <div class="courses-card">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <?php $blog_comments = $crudModel->get_blog_comments_by_blog_id($blog_details['blog_id']); ?>
                    <h1><?php echo $blog_comments->getNumRows().' '.get_phrase('Comments'); ?></h1>
                    <?php foreach($blog_comments->getResultArray() as $blog_comment): ?>
                            <?php $commenter_details = $userModel->get_all_user($blog_comment['user_id'])->getRowArray(); ?>
                        <div class="instructor-student-feed-back">
                            <div class="row">
                                <div class="col-lg-1 col-md-1 col-sm-1 col-2">
                                    <img loading="lazy" src="<?php echo $userModel->get_user_image_url($commenter_details['id']); ?>">
                                </div>
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-2 col-2">
                                    <?php if(session()->get('user_id') == $blog_comment['user_id'] || session()->get('admin_login') == true): ?>
                        ...
                        <?php foreach($crudModel->get_blog_comments_by_parent_id($blog_comment['blog_comment_id'])->getResultArray() as $child_comment): ?>
                            <?php $child_commenter_details = $userModel->get_all_user($child_comment['user_id'])->getRowArray(); ?>
                                <div class="reply">
                                    <div class="row">
                                        <div class="col-lg-1 col-md-1 col-sm-1 col-2">
                                            <img loading="lazy" src="<?php echo $userModel->get_user_image_url($child_commenter_details['id']); ?>">
                                        </div>
                                        <div class="col-lg-10 col-md-10 col-sm-9 col-8">
                                        ...
                                        <div class="col-lg-1 col-md-1 col-sm-2 col-2">
                                            <?php if(session()->get('user_id') == $child_comment['user_id'] || session()->get('admin_login') == true): ?>
                                                <div class="settings-icon dropdown">
                                                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-ellipsis-vertical"></i></a>
                                                    <ul class="dropdown-menu">
