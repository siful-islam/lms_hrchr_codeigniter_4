    ...
    <div class="container">
        ...
        <div class="instructor-slider owl-carousel owl-theme">
            ...
            <div class="h-3-expart-1">
                <img loading="lazy" onclick="redirectTo('<?php echo site_url('home/instructor_page/' . $top_instructor['id']); ?>')"
                    src="<?php echo $userModel->get_user_image_url($top_instructor['id']); ?>">
                <div class="h-3-expart-1-text">
                    <h4 onclick="redirectTo('<?php echo site_url('home/instructor_page/' . $top_instructor['id']); ?>')">
                        <?php echo $top_instructor['first_name'] . ' ' . $top_instructor['last_name']; ?></h4>
                    <p class="ms-auto me-auto ellipsis-line-3" style="max-width: 200px;text-align: center;"
                        onclick="redirectTo('<?php echo site_url('home/instructor_page/' . $top_instructor['id']); ?>')" class="ellipsis-line-2"><?php echo $top_instructor['title']; ?></p>
