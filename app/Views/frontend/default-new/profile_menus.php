...
<div class="wish-list-search mb-5">
    <div class="row">
        <div class="col-md-12">
            <div class="student-profile-info">
                <img loading="lazy" class="profile-image" src="<?php echo $userModel->get_user_image_url(session()->get('user_id')); ?>">
    ...
    <div class="wish-list-course">
        ...
        <?php if (addon_status('affiliate_course')) :
            ...
            $is_affilator = $affiliateModel->is_affilator(session()->get('user_id'));
            if ($is_affilator == 1) : ?>
