...
<section class="courses blog pb-3 mb-5 pt-4">
    <div class="container">
        <h1 class="text-center mb-2"><span><?php 
$crudModel = new \App\Models\Crud_model();
$userModel = new \App\Models\User_model();
echo get_phrase('Latest from our blog'); ?></span></h1>
        ...
        <div class="courses-card">
            <div class="row justify-content-center">
                <?php foreach($latest_blogs->getResultArray() as $latest_blog): ?>
                    <?php $user_details = $userModel->get_all_user($latest_blog['user_id'])->getRowArray(); ?>
                        ...
                        <a href="<?php echo site_url('blog/details/'.slugify($latest_blog['title']).'/'.$latest_blog['blog_id']); ?>" class="courses-card-body blogCard">
                            <div class="courses-card-image">
                                ...
                                <div class="courses-card-image-text position-absolute">
                                    <h3><?php echo $crudModel->get_blog_categories($latest_blog['blog_category_id'])->getRow()->title; ?></h3>
                                </div> 
                            </div>
    ...
    <?php if($popular_blogs->getNumRows() > 0): ?>
        <div class="container mb-4 mt-4">
            ...
            <div class="courses-card">
                <div class="row justify-content-center">
                    <?php foreach($popular_blogs->getResultArray() as $popular_blog): ?>
                        <?php $user_details = $userModel->get_all_user($popular_blog['user_id'])->getRowArray(); ?>
                        <div class="col-lg-4 col-md-6 ">
                            <a href="<?php echo site_url('blog/details/'.slugify($popular_blog['title']).'/'.$popular_blog['blog_id']); ?>" class="courses-card-body blogCard">
                                <div class="courses-card-image">
                                    ...
                                    <div class="courses-card-image-text position-absolute">
                                        <h3><?php echo $crudModel->get_blog_categories($popular_blog['blog_category_id'])->getRow()->title; ?></h3>
                                    </div> 
                                </div>
                                <div class="courses-text">
