...
echo get_phrase('Your Cart Items') ?></h3>
            </div>
            <div class="cart-scroll-bar">
                <table class="table ">
                    ...
                    <tbody>
                        <?php $total = 0; ?>
                        <?php foreach(session()->get('cart_items') ?? [] as $item): ?>
                            <?php $course_details = $crudModel->get_course_by_id($item)->getRowArray(); ?>
                          <tr>
                            <td>
    ...
    <div class="col-lg-3 col-md-4">
        <div class="cart-total">
            ...
            <?php if (isset($coupon_code) && !empty($coupon_code)) : ?>
                <?php if($crudModel->check_coupon_validity($coupon_code)): ?>
                    <?php $coupon_details = $crudModel->get_coupon_details_by_code($coupon_code)->getRowArray(); ?>
            ...
            <?php endif; ?>
            <div class="tax">
                <?php session()->set('total_price_of_checking_out', $total); ?>
