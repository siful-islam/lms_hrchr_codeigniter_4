...
<section class="blog-body courses blog pb-3 mb-5">
    <div class="container">
        <h1 class="text-center"><span><?php 
$crudModel = new \App\Models\Crud_model();
$userModel = new \App\Models\User_model();
echo get_phrase('Inspirational Journeys'); ?></span></h1>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <?php foreach($blogs->getResultArray() as $blog): ?>
                                ...
                                <a href="<?php echo site_url('blog/details/'.slugify($blog['title']).'/'.$blog['blog_id']); ?>" class="courses-card-body blogCard">
                                    <div class="courses-card-image">
                                        ...
                                        <div class="courses-card-image-text position-absolute">
                                            <h3><?php echo $crudModel->get_blog_categories($blog['blog_category_id'])->getRow()->title; ?></h3>
                                        </div> 
                                    </div>
