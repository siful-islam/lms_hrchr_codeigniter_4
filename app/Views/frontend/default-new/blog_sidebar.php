...
$popular_categories = $crudModel->get_categories_with_blog_number(6);
    ...
    <div class="search">
        <div class="search-bar">
            <form action="<?php echo site_url('blogs'); ?>" method="get">
                ...
                <input value="<?php if(isset($search_string) && !empty($search_string)) echo htmlspecialchars($search_string); ?>" type="text" name="search" class="form-control" placeholder="<?php echo site_phrase('Type your keywords'); ?>" id="search-place">
            </form>
        </div>
    </div>
    <div class="title">
    ...
    <div class="categories mb-4">
        <ul>
            <?php foreach($popular_categories as $popular_category): ?>
                <?php $blog_category = $crudModel->get_blog_categories($popular_category['blog_category_id'])->getRowArray(); ?>
