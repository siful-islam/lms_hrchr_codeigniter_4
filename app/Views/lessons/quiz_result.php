...
$quiz_results = $quiz_results->getRowArray(); ?>
...
<div class="col-12">
    <?php foreach($quiz_questions->getResultArray() as $question_number => $quiz_question):
        $question_number++;
    ...
    <?php
        $total_attemped = $db->where('quiz_id', $lesson_details['id'])->get('quiz_results')->getNumRows();
    ?>
