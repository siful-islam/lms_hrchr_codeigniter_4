...
echo base_url(); ?>assets/global/plyr/plyr.css">
...
<script type="text/javascript">
    ...
    <?php $student_id = session()->get('user_id'); ?>
    <?php $watched_duration = $db->table('watched_duration')->where(['watched_lesson_id' => $lesson_details['id'], 'watched_student_id' => $student_id])->get()->getRowArray(); ?>
