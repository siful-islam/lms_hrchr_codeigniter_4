        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title-1 mb-50px">
                    <h1 class="title-3 mb-26px fs-40px lh-52px fw-medium text-center builder-editable" builder-identity="1"><?php echo get_phrase('Featured Courses') ?></h1>
                    <p class="subtitle-typo1 fs-16px lms1-text-secondary text-center builder-editable" builder-identity="2">
