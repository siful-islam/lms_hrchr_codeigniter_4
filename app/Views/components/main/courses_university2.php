...
if (! isset($home_university2_assets)) {
   ...
   <section class="mb-100px">
       <div class="container">
           <div class="row">
               <div class="col-md-12">
                   <h1 class="title-1 fs-32px lh-36px fw-bold text-center mb-30 builder-editable" builder-identity="1"><?php echo get_phrase('Our Online Courses') ?></h1>
               </div>
           </div>
               ...
               <div class="row mb-100px">
                   <div class="col-12">
                       <div class="d-flex align-items-center justify-content-center">
                           <a href="<?php echo site_url('home/courses'); ?>" class="btn btn-danger-1 builder-editable" builder-identity="2"><?php echo get_phrase('See More') ?></a>
                       </div>
                   </div>
               </div>
