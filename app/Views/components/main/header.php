                        ...
                        <div class="wisth_tgl_2div">
                            ...
                            <div class="menu_pro_wish">
                                <div class="overflow-control" id="cartItems">
                                    ...
                                    <?php include APPPATH . "views/frontend/default-new/cart_items.php"; ?>
                                    ...
                                    <ul>
                                        <?php if ($user_login): ?>
                                            ...
                                            <?php if (addon_status('affiliate_course')) :
                                                ...
                                                $is_affiliator = $affiliateModel->is_affilator(session()->get('user_id'));
            ...
            <div class="offcanves-top">
                <?php if ($user_id > 0): ?>
                    <div class="offcanves-profile">
                        <a href="#">
                            <div class="user-img">
                                <img loading="lazy" src="<?php echo $userModel->get_user_image_url($user_id); ?>" alt="img" />
                            </div>
