...
<section class="mb-100px">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="title-1 fs-32px lh-36px fw-bold text-center mb-30 builder-editable" builder-identity="1"><?php echo get_phrase('Language Courses') ?></h1>
            </div>
        </div>
...
?>" href="javascript:void(0)" onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $latest_course['id'] . '/latest_course'); ?>'); ">
            ...
            <div class="col-lg-12">
                <div class="d-flex justify-content-center mt-2">
                    <a href="<?php echo site_url('home/courses') ?>" class="btn btn-outline-primary-1 builder-editable" builder-identity="2"><?php echo get_phrase('View More') ?></a>
                </div>
            </div>
