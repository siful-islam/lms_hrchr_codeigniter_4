        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <div class="title-two text-center pb-50">
                    <h4 class="title builder-editable" builder-identity="1"><?php echo get_phrase('Featured Courses') ?></h4>
                    <p class="info builder-editable" builder-identity="2"><?php echo get_phrase('These_are_the_most_latest_courses_among_Listen_Courses_learners_worldwide'); ?></p>
                </div>
            </div>
        </div>
