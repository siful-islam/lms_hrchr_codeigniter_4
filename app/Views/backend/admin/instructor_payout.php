...
echo get_phrase('instructor_payouts'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
                ...
                <ul class="nav nav-tabs nav-bordered mb-3">
                    ...
                    <li class="nav-item">
                        <a href="#pending-b1" data-toggle="tab" aria-expanded="false" class="nav-link">
                            ...
                            <span class="d-none d-lg-block"><?php echo get_phrase('pending_payouts'); ?> <span class="badge badge-danger-lighten"><?php echo $pending_payouts->getNumRows(); ?></span></span>
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane show active" id="completed-b1">
                        ...
                        <div class="table-responsive-sm mt-4">
                            <table id="completed-payout" class="table table-striped table-centered mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($completed_payouts->getResultArray() as $key => $completed_payout):
                                        $completed_payout_user_data = $db->table('users')->where(array('id' => $completed_payout['user_id']))->get()->getRowArray(); ?>
                                        <tr class="gradeU">
                                            <td> <?php echo ++$key; ?> </td>
                                            <td>
                                                <img src="<?php echo $userModel->get_user_image_url($completed_payout_user_data['id']);?>" alt="" height="50" width="50" class="img-fluid rounded-circle img-thumbnail">
                                            </td>
                                            <td>
                    ...
                    <div class="tab-pane" id="pending-b1">
                        <div class="table-responsive-sm mt-4">
                            <table id="pending-payout" class="table table-striped table-centered mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($pending_payouts->getResultArray() as $key => $pending_payout):
                                        $pending_payout_user_data = $db->table('users')->where(array('id' => $pending_payout['user_id']))->get()->getRowArray();
                                        ...
                                        <tr class="gradeU">
                                            <td> <?php echo ++$key; ?> </td>
                                            <td>
                                                <img src="<?php echo $userModel->get_user_image_url($pending_payout_user_data['id']);?>" alt="" height="50" width="50" class="img-fluid rounded-circle img-thumbnail">
                                            </td>
                                            <td>
