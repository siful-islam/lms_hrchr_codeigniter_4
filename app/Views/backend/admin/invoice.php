...
echo get_phrase('invoice'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
<?php
$payout_details = $crudModel->get_payouts($payout_id, 'payout')->getRowArray();
$instructor_details = $userModel->get_all_user($payout_details['user_id'])->getRowArray();
