...
$team_package_details = $teamPackageModel->get_team_package_by_id($team_package_id)->getRowArray();
$course_status = $team_package_details['privacy'];
if ($course_status == 'public') {
    $course_status = 'active';
}
$selected_course_ids = json_decode($team_package_details['course_id'], true);

if (!is_array($selected_course_ids)) {
    $selected_course_ids = [$team_package_details['course_id']];
}
$selected_course_price = 0;
$selected_course_expiry = null;
$courses = $teamPackageModel->get_status_wise_courses($course_status);

foreach ($courses as $course) {
    if (in_array($course['id'], $selected_course_ids)) {
        $selected_course_price += $course['price'];

        if (!empty($course['expiry_period'])) {
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                         <select class="form-control select2"
                                                                data-toggle="select2"
                                                                name="course_id[]"
                                                                id="course_id_on_package_create"
                                                                multiple>

                                                            <?php foreach ($courses as $course) : ?>
                                                                <option value="<?php echo $course['id']; ?>"
                                                                    <?php echo in_array($course['id'], $selected_course_ids) ? 'selected' : ''; ?>>
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        value="<?php echo $team_package_details['meta_title'] ?>"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea name="meta_description" class="form-control"><?php echo $team_package_details['meta_description']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="website_keywords"><?php echo get_phrase('meta_keywords'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control bootstrap-tag-input" id="meta_keywords" name="meta_keywords" data-role="tagsinput" style="width: 100%;" value="<?php echo $team_package_details['meta_keywords']; ?>" placeholder="<?php echo get_phrase('write_a_keyword_and_then_press_enter_button'); ?>" . />
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        value="<?php echo $team_package_details['og_title'] ?>"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea name="og_description" class="form-control"><?php echo $team_package_details['og_description']; ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea class="form-control" id="json_ld" name="json_ld" rows="5"><?php echo $team_package_details['json_ld']; ?></textarea>
                                                    </div>
                                                </div>
    ...
    $(document).ready(function() {
        ...
        $('#course_id_on_package_create').on('change', function() {
            ...
            if (courseIds && courseIds.length > 0) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo base_url('addons/team_training/get_course_by_ids'); ?>',
                    data: {
                        course_id: courseIds
                    },
                    dataType: 'json',
                    ...
                    success: function(response) {
                        ...
                        let totalPrice = 0;
                        let expiryPeriod = null;

                        $.each(response, function(index, course) {
                            totalPrice += parseFloat(course.price || 0);

                            if (course.expiry_period !== null && course.expiry_period !== '') {
                                expiryPeriod = course.expiry_period;
                            }
                        });

                        if (expiryPeriod == null) {
                            $("#lifetime_expiry_period").prop('checked', true).trigger('change');
																		   
                        } else {

                            $("#package_expiry_month").val(expiryPeriod);

																															

                            $("#limited_expiry_period").prop('checked', true).trigger('change');
                        ...
                        if (maxStudent == '' || maxStudent == 0) {
                            ...
                            $("#subtotal").val(totalPrice * maxStudent);
                        }
                    },
        ...
        $('#max_students_for_package_create').change(function(e) {
         ...
         $('#max_students_for_package_create').on('change keyup', function() {

            let maxStudent = $(this).val();
            let courseIds = $("#course_id_on_package_create").val(); // array
