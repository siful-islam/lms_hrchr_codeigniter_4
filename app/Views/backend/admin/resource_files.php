<div class="resource_file_content">
	<form class="ajaxFormSubmission resetable" action="<?php 
$db = \Config\Database::connect();
echo site_url('admin/resource_files/add/'.$param2); ?>" method="post" enctype="multipart/form-data">
	...
	<ul class="pl-0 pt-2 mt-3 border-top" style="list-style: none;">
		...
		<?php $resource_files = $db->orderBy('id', 'desc')->where('lesson_id', $param2)->get('resource_files')->getResultArray(); ?>
