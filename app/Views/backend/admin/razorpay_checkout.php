...
<html lang="en">
	<head>
		<title>Razorpay | <?php 
$paymentModel = new \App\Models\Payment_model();
echo get_settings('system_name');?></title>
		<meta charset="UTF-8">
	...
	<body style="background-color: #fff !important;">
		...
		<?php $preparedData = $paymentModel->razorpayPrepareData($user_details['id'], true, $amount_to_pay); ?>
