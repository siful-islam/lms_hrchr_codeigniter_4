    ...
    <div class="col-md-10">
      <div class="wrapper-image-preview" style="margin-left: -6px;">
        <div class="box" style="width: 250px;">
          <div class="js--image-preview" style="background-image: url(<?php echo $crudModel->get_course_thumbnail_url($course_details['id'], $course_media);?>); background-color: #F5F5F5;"></div>
