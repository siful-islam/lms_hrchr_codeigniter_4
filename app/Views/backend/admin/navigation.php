...
$status_wise_courses = $crudModel->get_status_wise_courses();
?>
<!-- ========== Left Sidebar Start ========== -->
<div class="left-side-menu left-side-menu-detached">
    <div class="leftbar-user">
        <a href="javascript: void(0);">
            <img src="<?php echo $userModel->get_user_image_url(session()->get('user_id')); ?>" alt="user-image" height="42" class="rounded-circle shadow-sm">
            <?php
                $admin_details = $userModel->get_all_user(session()->get('user_id'))->getRowArray();
            ?>
                ...
                <li class="<?php if ($page_name == 'active_affiliator' || $page_name == 'suspend_affiliator' || $page_name == 'pending_affiliator') {
                    ...
                    <a href="<?php echo site_url('addons/affiliate_course/active_affiliator'); ?>">
                        ...
                        <span class="badge badge-danger-lighten">
                            ...
                            <?php
                            echo $affiliateModel->get_pending_affiliator_application()->getNumRows();
                            ?></span>
                ...
                <li class="<?php if ($page_name == 'affiliation_course_payouts') {
                    ...
                    <a href="<?php echo site_url('addons/affiliate_course/affiliation_course_payouts'); ?>">
                        ...
                        <span class="badge badge-danger-lighten">
                            ...
                            <?php
                            echo $affiliateModel->get_table_pending_course_amount_info_from_course_affiliation_payouts()->getNumRows();
                            ?></span>
                    </a>
                </li>
                    ...
                    <ul class="side-nav-third-level" aria-expanded="false">
                        ...
                        <li class="<?php if ($page_name == 'instructor_payout') {
                            ...
                            <a href="<?php echo site_url('admin/instructor_payout'); ?>">
                                ...
                                <span class="badge badge-danger-lighten"><?php echo $crudModel->get_pending_payouts()->getNumRows(); ?></span>
                            </a>
                        </li>
                        ...
                        <li class="<?php if ($page_name == 'application_list') {
                            ...
                            <a href="<?php echo site_url('admin/instructor_application'); ?>">
                                ...
                                <span class="badge badge-danger-lighten"><?php echo $userModel->get_pending_applications()->getNumRows(); ?></span>
                            </a>
                        </li>
                    </ul>
                </li>
...
?>">
                ...
                <?php
                    $db->where('receiver', session()->get('user_id'));
                    $db->where('read_status !=', 1);
                    $unreaded_message = $db->table('message')->get()->getNumRows();
                ?>
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/contact'); ?>" class="side-nav-link<?php if ($page_name == 'contact'): ?> active<?php endif; ?>">
                ...
                <?php $unread_contact = $db->where('has_read', null)->get('contact')->getNumRows(); ?>
            ...
            <ul class="side-nav-second-level" aria-expanded="false">
                ...
                <li class="<?php if ($page_name == 'instructors_pending_blog') {
                    ...
                    <a href="<?php echo site_url('admin/instructors_pending_blog'); ?>"><?php echo get_phrase('pending_blog'); ?> <span
                            class="badge badge-danger-lighten"><?php echo $crudModel->get_instructors_pending_blog()->getNumRows(); ?></span></a>
                </li>
...
?>">
        ...
        <li class="side-nav-item                                		                         <?php if ($page_name == 'manage_profile') {
                                                                 ...
                                                                 ?>">
            <a href="<?php echo site_url(strtolower(session()->get('role')) . '/manage_profile'); ?>" class="side-nav-link">
