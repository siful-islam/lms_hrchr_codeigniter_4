                ...
                <table class="table table-bordered datatable" id="table-1">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    $admin_details = $userModel->get_admin_details()->getRowArray();
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    $category_name = \Config\Database::connect()->table('category')->where(array('id' => $course_details['category_id']))->get()->getRow()->name;
                                    echo $category_name;
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php
                                    $sub_category_name = \Config\Database::connect()->table('category')->where(array('id' => $course_details['sub_category_id']))->get()->getRow()->name;
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    $lessons = $db->table('lesson')->where(array('course_id' => $course_details['id']))->get();
                                    echo $lessons->getNumRows().' '.get_phrase('lessons');
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php
                                    $enrolled_students = $db->table('enrol')->where(array('course_id' => $course_details['id']))->get();
                                    echo $enrolled_students->getNumRows().' '.get_phrase('students');
                                ?>
                            </td>
                        </tr>
                        <tr>
