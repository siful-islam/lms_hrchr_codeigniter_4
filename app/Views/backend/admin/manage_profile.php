...
echo get_phrase('manage_profile'); ?></h4>
			</div> <!-- end card body-->
		</div> <!-- end card -->
	</div><!-- end col-->
</div>
		...
		<div class="card">
			<div class="card-body">
				...
				foreach($edit_data as $row):
					...
					<div class="form-group">
						<label><?php echo get_phrase('company_name');?></label>
					...
					<div class="form-group">
						...
						<div class="d-flex mt-2">
							<div class="">
								<img class = "rounded-circle img-thumbnail" src="<?php echo $userModel->get_user_image_url(session()->get('user_id')); ?>" alt="" style="height: 50px; width: 50px;">
							</div>
