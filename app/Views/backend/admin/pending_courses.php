                  ...
                  <tbody>
                      <?php
                          ...
                          <tr>
                              ...
                              <td>
                                  <?php
                                  $category_details = $crudModel->get_categories($course['category_id'])->getRowArray();
                                  echo $category_details['name'];
                                  ?>
                              </td>
                              <td>
                                  <?php
                                  $subcategory_details = $crudModel->get_category_details_by_id($course['sub_category_id'])->getRowArray();
                              ...
                              <td>
                                  <?php
                                     if ($course['user_id'] > 0) {
                                         ...
                                         $admin_details = $userModel->get_admin_details();
                              ...
                              <td hidden>
                                  <ul style="list-style-type:square">
                                      <?php
                                      $lessons = $crudModel->get_lessons('course', $course['id'])->getResultArray();
                          ...
                          <td>
                              ...
                              echo $sections->getNumRows();
                              ?>
                          </td>
                          <td>
                              <?php
                              $lessons = $crudModel->get_lessons('course', $course['id']);
                              echo $lessons->getNumRows();
                              ?>
                          </td>
                          <td>
                              <?php
                              $enrol_history = $crudModel->enrol_history($course['id']);
                              echo $enrol_history->getNumRows();
                              ?>
                          </td>
                          <td>
                              <div class="btn-group">
