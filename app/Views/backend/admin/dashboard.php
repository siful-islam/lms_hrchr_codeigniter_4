...
$status_wise_courses = $crudModel->get_status_wise_courses();
    $number_of_courses = $status_wise_courses['pending']->getNumRows() + $status_wise_courses['active']->getNumRows();
    $number_of_lessons = $crudModel->get_lessons()->getNumRows();
    $number_of_enrolment = $crudModel->enrol_history()->getNumRows();
    $number_of_students = $userModel->get_user()->getNumRows();
?>
<div class="row">
    <div class="col-xl-12">
        <div class="card">
                ...
                <div class="row text-center mt-2 py-2">
                    <div class="col-6">
                        ...
                        <h3 class="font-weight-normal">
                            <span><?php echo $status_wise_courses['active']->getNumRows(); ?></span>
                        </h3>
                    ...
                    <div class="col-6">
                        ...
                        <h3 class="font-weight-normal">
                            <span><?php echo $status_wise_courses['pending']->getNumRows(); ?></span>
                        </h3>
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-hover mb-0">
                        <tbody>
                            ...
                            <?php
                                $pending_payouts = $crudModel->get_pending_payouts()->getResultArray();
                                foreach ($pending_payouts as $key => $pending_payout):
                                $instructor_details = $userModel->get_all_user($pending_payout['user_id'])->getRowArray();
                            ?>
                            <tr>
                                <td>
