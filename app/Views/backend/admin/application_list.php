...
echo get_phrase('instructor_applications'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
                    ...
                    <div class="tab-pane show active" id="pending-b1">
                        <div class="table-responsive-sm mt-4">
                            <table id="pending-application" class="table table-striped table-centered mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($pending_applications->getResultArray() as $key => $pending_application):
                                        $user_data = $userModel->get_all_user($pending_application['user_id'])->getRowArray();?>
                                        <tr class="gradeU">
                                            <td>
                                                <?php echo ++$key; ?>
                                            </td>
                    ...
                    <div class="tab-pane" id="approved-b1">
                        <div class="table-responsive-sm mt-4">
                            <table id="approved-application" class="table table-striped table-centered mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($approved_applications->getResultArray() as $key => $approved_application):
                                        $user_data = $userModel->get_all_user($approved_application['user_id'])->getRowArray();?>
                                        <tr class="gradeU">
                                            <td>
                                                <?php echo ++$key; ?>
                                            </td>
