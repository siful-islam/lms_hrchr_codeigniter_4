...
echo get_phrase('blog_categories'); ?>
			...
			<ul class="list-group list-group-numbered">
				<li class="list-group-item d-flex justify-content-between align-items-start">
					...
					<div class="ml-auto text-center">
						<span class="badge badge-primary text-right"><?php echo $crudModel->get_blogs_by_category_id($category['blog_category_id'])->getNumRows(); ?></span>
