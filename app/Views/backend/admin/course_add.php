...
echo get_phrase('add_new_course'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
                        ...
                        <form class="required-form" action="<?php echo site_url('admin/course_actions/add'); ?>" method="post" enctype="multipart/form-data">
                            <div class="scrollable-tab-section" id="basicwizard">
                                ...
                                <div class="tab-content b-0 mb-0">
								  ...
								  <!-- Live class enable/disable -->
											 <div class="form-group row mb-3">
                                                <div class="offset-md-2 col-md-10">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" name="is_live_class" id="is_live_class" value="1">
                                                        <label class="custom-control-label" for="is_live_class"><?php echo get_phrase('check_if_this_course_is_live_class'); ?></label>
                                                    </div>
                                                </div>
                                            </div>		  
                                        </div> <!-- end col -->
