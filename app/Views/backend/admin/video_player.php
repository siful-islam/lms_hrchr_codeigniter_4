...
$lesson_details = $crudModel->get_lessons('lesson', $lesson_id)->getRowArray();
    $lesson_thumbnail_url = $crudModel->get_lesson_thumbnail_url($lesson_id);
    $course_details = $crudModel->get_course_by_id($lesson_details['course_id'])->getRowArray();
?>
<ul class="breadcrumb">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                          <?php if ($lesson_details['lesson_type'] != 'other'): ?>
                            ...
                            <?php elseif (strtolower($provider) == 'vimeo'):
                                  $video_details  = $videoModel->getVideoDetails($video_url);?>
                              <!------------- PLYR.IO ------------>
                                <link rel="stylesheet" href="<?php echo base_url();?>assets/global/plyr/plyr.css">
                                <div class="plyr__video-embed" id="player">
