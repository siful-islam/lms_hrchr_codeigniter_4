...
$months = array('january', 'february', 'march', 'april', 'may', 'june', 'july', 'august', 'september', 'october', 'november', 'december');
    ...
    $number_of_active_course = $status_wise_courses['active']->getNumRows();
    $number_of_pending_course = $status_wise_courses['pending']->getNumRows();
?>
