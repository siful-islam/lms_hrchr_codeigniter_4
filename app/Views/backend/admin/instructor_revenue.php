          ...
          <table id="basic-datatable" class="table table-striped table-centered mb-0">
            ...
            <tbody>
              <?php foreach ($payment_history as $payment) :
                $course_data = $db->table('course')->where(array('id' => $payment['course_id']))->get()->getRowArray();
                $user_data = $db->table('users')->where(array('id' => $course_data['user_id']))->get()->getRowArray();
