...
$user_data = $db->table('users')->where(array('id' => $user_id))->get()->getRowArray();
 ...
 <label class="col-md-3 col-form-label" for="company_name"><?php echo get_phrase('company_name'); ?> <span class="required">*</span> </label>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <div class="d-flex">
                                                  <div class="">
                                                      <img class = "rounded-circle img-thumbnail" src="<?php echo $userModel->get_user_image_url($user_data['id']);?>" alt="" style="height: 50px; width: 50px;">
                                                  </div>
                            ...
                            <div class="tab-pane" id="payment_info">
                                <div class="row">
                                    <div class="col-12">
                                        <?php $payment_gateways = $db->table('payment_gateways')->get()->getResultArray();
