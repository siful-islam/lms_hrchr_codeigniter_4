...
echo site_url('admin/newsletter_history/pending') ?>" class="text-secondary">
            <div class="card shadow-none m-0">
                <div class="card-body text-center">
                    <h3><span><?php echo $db->where('status', 'pending')->get('newsletter_histories')->getNumRows(); ?></span></h3>
    ...
    <div class="col-sm-6 col-xl-3">
        <a href="<?php echo site_url('admin/newsletter_history/sent') ?>" class="text-secondary">
            <div class="card shadow-none m-0 border-left rounded-0">
                <div class="card-body text-center">
                    <h3><span><?php echo $db->where('status', 'sent')->get('newsletter_histories')->getNumRows(); ?></span></h3>
    ...
    <div class="col-sm-6 col-xl-3">
        <a href="<?php echo site_url('admin/newsletter_history/faild') ?>" class="text-secondary">
            <div class="card shadow-none m-0 border-left rounded-0">
                <div class="card-body text-center">
                    <h3><span><?php echo $db->where('status', 'faild')->get('newsletter_histories')->getNumRows(); ?></span></h3>
    ...
    <div class="col-sm-6 col-xl-3">
        <a href="<?php echo site_url('admin/newsletter_history/unable') ?>" class="text-secondary">
            <div class="card shadow-none m-0 border-left rounded-0">
                <div class="card-body text-center">
                    <h3><span><?php echo $db->where('status', 'unable')->get('newsletter_histories')->getNumRows(); ?></span></h3>
