...
echo site_url(session()->get('role')); ?>" class="topnav-logo" style="min-width: unset;">
        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-59px, 72px, 0px);">
                    ...
                    foreach ($languages as $language) : ?>
                        <?php if (trim($language) != "" && session()->get('language') != strtolower($language)) : ?>
            ...
            <?php if (session()->get('is_instructor') == 1 || session()->get('admin_login') == 1) : ?>
                <li class="dropdown notification-list topbar-dropdown">
                    <?php if (addon_status('course_ai')) : ?>
                        <?php if (session()->get('admin_login') == 1) : ?>
                ...
                <li class="dropdown notification-list">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg p-0 mt-5 border-top-0" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-278px, 70px, 0px);">
                        ...
                        <div class="row row-paddingless" style="padding-left: 15px; padding-right: 15px;">
                            <!--begin:Item-->
                            <?php if (session()->get('is_instructor') == 1 && !session()->get('admin_login')  || has_permission('course')) : ?>
                            ...
                            <?php if (session()->get('admin_login') && has_permission('student')) : ?>
                            ...
                            <?php if (session()->get('admin_login') && has_permission('enrolment')) : ?>
                                <div class="col-6 p-0">
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown" id="topbar-userdrop" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <span class="account-user-avatar">
                        <img src="<?php echo $userModel->get_user_image_url(session()->get('user_id')); ?>" alt="user-image" class="rounded-circle">
                    </span>
                    <span style="color: #fff;">
                        <?php
                        $logged_in_user_details = $userModel->get_all_user(session()->get('user_id'))->getRowArray();
                        ?>
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu profile-dropdown" aria-labelledby="topbar-userdrop">
                    ...
                    <!-- Account -->
                    <?php if (session()->get('admin_login') == 1) : ?>
                        <a href="<?php echo site_url(strtolower(session()->get('role')) . '/manage_profile'); ?>" class="dropdown-item notify-item">
        ...
        <div class="visit_website">
            <h4 style="color: #fff; float: left;" class="d-none d-md-inline-block"> <?php echo \Config\Database::connect()->table('settings')->where(array('key' => 'system_name'))->get()->getRow()->value; ?></h4>
