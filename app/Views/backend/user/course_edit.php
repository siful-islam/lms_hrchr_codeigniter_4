                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        ?>
                                                            <?php foreach ($instructor_ids as $instructor_id) : ?>
                                                                <?php $instructor_details = $userModel->get_instructor($instructor_id)->getRowArray(); ?>
                                                                <div class="m-2">
                                                                    <img class="rounded-circle" src="<?php echo $userModel->get_user_image_url($instructor_details['id']);; ?>" height="30px" alt="">
                                                            ...
                                                            <?php endforeach; ?>
                                                        <?php else : ?>
                                                            <?php $instructor_details = $userModel->get_instructor($course_details['user_id'])->getRowArray(); ?>
                                                            <div>
                                                                <img class="rounded-circle" src="<?php echo $userModel->get_user_image_url($instructor_details['id']);; ?>" height="30px" alt="">
                                                                <span style="font-weight: 700; font-size: 15px; vertical-align: sub; margin-left: 6px;">
                                                                    <?php echo html_escape($instructor_details['first_name'] . ' ' . $instructor_details['last_name']); ?>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="select2 form-control select2-multiple" data-toggle="select2" multiple="multiple" data-placeholder="Choose ..." name="new_instructors[]">
                                                            <?php $instructors = $userModel->get_instructor()->getResultArray(); ?>
