...
echo get_phrase('your_application'); ?></h4>
<div class="table-responsive-sm mt-4">
    <table id="basic-datatable" class="table table-striped table-centered mb-0">
        ...
        <tbody>
            <?php foreach ($applications->getResultArray() as $key => $application):
                $user_data = $userModel->get_all_user($application['user_id'])->getRowArray();?>
                <tr class="gradeU">
                    <td>
                        <?php echo ++$key; ?>
                    </td>
