...
<div class="row">
    <div class="<?php if($pending_blogs->getNumRows() > 0){echo 'col-xl-9'; }else{ echo 'col-xl-12'; } ?>">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title"><?php echo get_phrase('total_pending'); ?> <?php echo $pending_blogs->getNumRows(); ?> <?php echo get_phrase('blogs'); ?></h4>
                <div class="table-responsive-sm mt-4">
                    <table id="basic-datatable" class="table table-striped dt-responsive nowrap dataTable no-footer dtr-inline collapsed">
                        ...
                        <tbody>
                            <?php
                            foreach ($pending_blogs->getResultArray() as $key => $blog) : ?>
                            	<?php $user_details = $userModel->get_all_user($blog['user_id'])->getRowArray(); ?>
                                <tr>
                                    ...
                                    <td><?php echo $crudModel->get_blog_categories($blog['blog_category_id'])->getRow()->title; ?></td>
                                    <td>
    ...
    <?php if($pending_blogs->getNumRows() > 0): ?>
        <div class="col-xl-3">
