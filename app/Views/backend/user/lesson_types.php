        ...
        <div class="col-md-12">
            <div class="form-group">
                <select class="select2" id="course_id_for_lesson" name="course_id_for_lesson">
                    ...
                    <?php foreach($crudModel->get_course_by_user(session()->get('user_id'), 'general')->getResultArray() as $course): ?>
...
<?php else: ?>
    <div class="alert alert-info" role="alert">
        Course: <strong><?= $crudModel->get_course_by_id($param2)->getRow()->title; ?></strong>
    </div>
