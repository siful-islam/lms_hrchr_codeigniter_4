...
$sections = $crudModel->get_section('course', $course_id)->getResultArray();
?>
<div class="row justify-content-center">
    <div class="col-xl-12 mb-4 text-center mt-3"> 
		 <a href="javascript:void(0)" class="btn btn-outline-primary btn-rounded btn-sm ml-1" onclick="showAjaxModal('<?php echo site_url('modal/popup/section_add/'.$course_id); ?>', '<?php echo get_phrase('add_new_section'); ?>', 'sm', false)"><i class="mdi mdi-plus"></i> <?php echo get_phrase('add_section'); ?></a>
            ...
            <div class="col-xl-12">
                <div class="card bg-light text-seconday on-hover-action mb-5" id = "section-<?php echo $section['id']; ?>">
                    <div class="card-body">
                        ...
                        <?php
                        $lessons = $crudModel->get_lessons('section', $section['id'])->getResultArray();
