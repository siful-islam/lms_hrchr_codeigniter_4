...
$instructor_id = session()->get('user_id');
    $number_of_courses = $crudModel->get_instructor_wise_courses($instructor_id)->getNumRows();
    $number_of_enrolment_result = $crudModel->instructor_wise_enrolment($instructor_id);
    if ($number_of_enrolment_result) {
        $number_of_enrolment = $number_of_enrolment_result->getNumRows();
    }else{
        $number_of_enrolment = 0;
    }
    $total_pending_amount = $crudModel->get_total_pending_amount($instructor_id);
    $requested_withdrawal_amount = $crudModel->get_requested_withdrawal_amount($instructor_id);
 ?>
                ...
                <div class="row text-center mt-2 py-2">
                    <div class="col-6">
                        ...
                        <h3 class="font-weight-normal">
                            <span><?php echo $crudModel->get_status_wise_courses_for_instructor('active')->getNumRows(); ?></span>
                        </h3>
                    ...
                    <div class="col-6">
                        ...
                        <h3 class="font-weight-normal">
                            <span><?php echo $crudModel->get_status_wise_courses_for_instructor('pending')->getNumRows(); ?></span>
                        </h3>
