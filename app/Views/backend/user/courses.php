                        ...
                        <a href="<?php echo site_url('user/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>
                                        <?php
                                            $active_courses = $crudModel->get_status_wise_courses_for_instructor('active');
                                            echo $active_courses->getNumRows();
                                         ?>
                                    </span></h3>
                        ...
                        <a href="<?php echo site_url('user/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>
                                        <?php
                                            $pending_courses = $crudModel->get_status_wise_courses_for_instructor('pending');
                                            echo $pending_courses->getNumRows();
                                         ?>
                                    </span></h3>
                        ...
                        <a href="<?php echo site_url('user/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>
                                        <?php
                                            $draft_courses = $crudModel->get_status_wise_courses_for_instructor('draft');
                                            echo $draft_courses->getNumRows();
                                         ?>
                                    </span></h3>
                        ...
                        <a href="<?php echo site_url('user/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $crudModel->get_free_and_paid_courses('free', session()->get('user_id'))->getNumRows(); ?></span></h3>
                        ...
                        <a href="<?php echo site_url('user/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $crudModel->get_free_and_paid_courses('paid', session()->get('user_id'))->getNumRows(); ?></span></h3>
                    ...
                    <table id="course-datatable" class="table table-striped dt-responsive nowrap" width="100%" data-page-length='25'>
                        ...
                        <tbody>
                            <?php foreach ($courses as $key => $course):
                                ...
                                $category_details = $crudModel->get_category_details_by_id($course['sub_category_id'])->getRowArray();
                                $sections = $crudModel->get_section('course', $course['id']);
                                $lessons = $crudModel->get_lessons('course', $course['id']);
                                $enroll_history = $crudModel->enrol_history($course['id']);
                            ?>
                                <tr>
                                    <td><?php echo ++$key; ?></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <?php if($course['course_type'] == 'general'): ?>
                                            <small class="text-muted"><?php echo '<b>'.get_phrase('total_section').'</b>: '.$sections->getNumRows(); ?></small><br>
                                            <small class="text-muted"><?php echo '<b>'.get_phrase('total_lesson').'</b>: '.$lessons->getNumRows(); ?></small>
                                        <?php else: ?>
                                            <span class="badge badge-info-lighten"><?= $course['course_type']; ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <small class="text-muted"><?php echo '<b>'.get_phrase('total_enrolment').'</b>: '.$enroll_history->getNumRows(); ?></small>
                                    </td>
