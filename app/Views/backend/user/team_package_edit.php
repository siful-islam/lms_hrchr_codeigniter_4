...
$course_details = $crudModel->get_course_by_id($team_package_details['course_id'])->getRowArray();

$courses = $teamPackageModel->get_status_wise_courses('active', session()->get('user_id'));
