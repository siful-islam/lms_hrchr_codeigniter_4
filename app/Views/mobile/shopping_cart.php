...
$total_price = 0;
$course_details = $crudModel->get_course_by_id($cart_item)->getRowArray();
$instructor_details = $userModel->get_all_user($course_details['user_id'])->getRowArray();
$this_mobile_view = 'mobile';
$check_course_enrolled = $crudModel->check_course_enrolled($cart_item, $user_id);
?>
<div class="row px-1 mb-5">
	<div class="col-12">
		<img src="<?php echo $crudModel->get_course_thumbnail_url($cart_item); ?>" alt="" class="img-fluid" width='100%' style="height: 95%;">
	</div>
	<div class="col-12">
		<div class="details">
			...
			<div class="row mt-1">
				...
				<div class="col-8 cart-course-wrapper p-0">
					<?php if ($course_details['is_free_course'] == 1) : ?>
						<?php $total_price = 0; ?>
						<?php session()->set('total_price_of_checking_out', $total_price); ?>
