...
class Academy_cloud_model extends NativeBaseModel
{
    ...
    function upload_video(){
      $video_title = htmlspecialchars_($this->request->getPost('title'));
    ...
    function save_access_token(){
      $data['value'] = $this->request->getPost('access_token');
      $query = $this->db->table('settings')->where(['key' => 'academy_cloud_access_token'])->get();
